...
sudo kubectl apply -f /tmp/dashboard-2.7.0.yaml
#RBAC for the dashboard (we only have access to pods in the kubernetes-dashboard namespace)
sudo kubectl -n kubernetes-dashboard create rolebinding insecure --serviceaccount kubernetes-dashboard:kubernetes-dashboard --clusterrole view
sudo kubectl -n kubernetes-dashboard create clusterrolebinding insecure --serviceaccount kubernetes-dashboard:kubernetes-dashboard --clusterrole view
#HOME=/home/iptcp
